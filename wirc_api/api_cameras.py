...
async def start_video(rpi_camera: str = "camera-a"):
    """ """
    try:
...
async def stop_video(rpi_camera: str = "camera-a"):
    """ """
    try:
...
async def camera_commands(command: str, rpi_camera: str = "camera-a"):
    """ """
    try:
